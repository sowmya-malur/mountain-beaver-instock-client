    ...
    <section className="add-warehouse">
      ...
      <form className="add-warehouse__form">
        <div className="add-warehouse__details">
          ...
          />
          <label htmlFor="streetAddress" className="add-warehouse__label">Street Address</label>
          <input
            type="text"
            name="streetAddress"
            id="streetAddress"
            ...
            className="add-warehouse__field"
          />
          <label htmlFor="city" className="add-warehouse__label">City</label>
          <input type="text" name="city" id="city" placeholder="City" className="add-warehouse__field"/>
          <label htmlFor="country" className="add-warehouse__label">Country</label>
          <input
            type="text"
            name="country"
            id="country"
        ...
        <div className="add-warehouse__contact">
          ...
          <label htmlFor="contactName" className="add-warehouse__label">Contact Name</label>
          <input
            type="text"
            name="contactName"
            id="contactName"
            ...
            className="add-warehouse__field"
          />
          <label htmlFor="position" className="add-warehouse__label">Position</label>
          <input
            type="text"
            name="position"
            id="position"
            ...
            className="add-warehouse__field"
          />
          <label htmlFor="phoneNumber" className="add-warehouse__label">Phone Number</label>
          <input
            type="text"
            name="phoneNumber"
            id="phoneNumber"
